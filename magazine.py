...
class magazine(pygame.sprite.Sprite):
    def __init__(self, size, bullets, image, magPlus = False):
        pygame.sprite.Sprite.__init__(self, self.containers)
        print "MagPlus", magPlus
        print "default", bullets
        self.bulletImages = [pygame.image.load("PNG/Bolt/bulletmag0.png"),
                             ...
                             pygame.image.load("PNG/Bolt/bulletmag41.png"),
        ...
        print len(self.bulletImages)
        self.image = self.bulletImages[bullets]
        self.rect = self.image.get_rect(center=[980,265])
